...
void CreatePackDialog::settingsToUI(const TexturePackSettings &settings)
{
    ...
    else if (settings.mOutputImageSize == QSize(4096, 4096))
        ui->texSizeCombo->setCurrentIndex(3);
    else if (settings.mOutputImageSize == QSize(8192, 8192))
        ui->texSizeCombo->setCurrentIndex(4);
    else
...
void CreatePackDialog::settingsFromUI(TexturePackSettings &settings)
{
    ...
    else if (ui->texSizeCombo->currentIndex() == 3)
        settings.mOutputImageSize = QSize(4096, 4096);
    else if (ui->texSizeCombo->currentIndex() == 4)
        settings.mOutputImageSize = QSize(8192, 8192);
    else
