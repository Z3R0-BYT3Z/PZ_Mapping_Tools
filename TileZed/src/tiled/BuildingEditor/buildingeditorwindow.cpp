Warning: truncated output (original token count: 35335)
Total output lines: 3479
    ...
    mDocumentChanging(false)
{
    ...
    showInvisibleTilesAction->setToolTip(tr(
        "Show crossed-eye markers for transparent and explicitly invisible tiles"));
...
void BuildingEditorWindow::currentDocumentChanged(BuildingDocument *doc)
{
    ...
    if (mCurrentDocument) {
        ...
        ModeManager::instance().setCurrentMode(mo…5335 tokens truncated…ingEd clipboard pasted at" << targetPos
