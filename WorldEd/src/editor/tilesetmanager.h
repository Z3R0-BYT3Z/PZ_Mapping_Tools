...
public:
     ...
     * deleted.
     */
    void addReference(Tileset *tileset, bool loadImage = true);
     ...
     * @see addReference
     */
    void addReferences(const QList<Tileset*> &tilesets, bool loadImages = true);
    ...
    void waitForTilesets(const QList<Tileset *> &tilesets = QList<Tileset*>(),
                         QWidget *parent = nullptr, int expectedTotal = -1);
