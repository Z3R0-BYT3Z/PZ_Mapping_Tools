...
MapInfo *MapManager::getEmptyMap(int width, int height)
{
    const QString mapFilePath = QStringLiteral("<empty-%1x%2>")
...
void MapManager::buildingLoadedByThread(Building *building, MapInfo *mapInfo)
{
    ...
    TilesetManager::instance()->waitForTilesets({ usedTilesets.begin(), usedTilesets.end() });
