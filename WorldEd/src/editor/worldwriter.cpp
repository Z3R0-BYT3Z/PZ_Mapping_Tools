...
public:
    ...
    void writeWorld(QXmlStreamWriter &w, World *world)
    {
        ...
        w.writeAttribute(QLatin1String("cellFormat"), worldGridFormatName(world->gridFormat()));
...
//            w.writeAttribute(QLatin1String("visible"), QLatin1String("0"));
    ...
    void writeGenerateLots(QXmlStreamWriter &w)
    {
        ...
        w.writeEndElement();
        w.writeStartElement(QLatin1String("BiomeMap"));
        w.writeAttribute(QLatin1String("path"),
                         relativeFileName(settings.biomeMap));
        w.writeEndElement();
