...
public:
    ...
    int samplesPerCell() const { return mSamplesPerCell; }
    ...
    bool reloadFromSettings(QString *error = nullptr);
    bool replaceSourceImage(const QImage &image, bool saveToDisk,
                            QString *error = nullptr);
    bool save(QString *error = nullptr);
    bool expandToWorld(QString *error = nullptr);
...
public:
    ...
    World *world() const;
    ZombieSpawnImageItem *zombieSpawnImageItem() const
    { return mZombieSpawnImageItem; }
    BiomeMapItem *biomeMapItem() const
    { return mBiomeMapItem; }
